...
(function () {
	...
	document.getElementById("btn-nova-tarefa-home").addEventListener("click", function (evt) {
		novoBloqueiaExclusaoTarefa();
	});
	// pega acao do botao Nova Tarefa acima da tabela de tarefas
	document.getElementById("btn-nova-tarefa").addEventListener("click", function (evt) {
		novoBloqueiaExclusaoTarefa();
	});
	// pega acao do botao excluir tarefa dentro do modal de tarefa
	document.getElementById("btn-excluir-tarefa").addEventListener("click", function (evt) {
		excluiTarefaByButton();
	});
	// pega acao do botao limpar tarefa dentro do modal de tarefa
	document.getElementById("btn-limpar-tarefa").addEventListener("click", function (evt) {
		zeraInputTarefa();
	});
	// pega acao do botao editar tarefa dentro do modal de tarefa
	document.getElementById("btn-editar-tarefa").addEventListener("click", function (evt) {
		liberaEdicaoTarefa();
	});
	// pega acao do botao salvar tarefa dentro do modal de tarefa
	document.getElementById("form-tarefas").addEventListener("submit", function (evt) {
		salvarTarefas();
